    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          iconTheme:
              IconThemeData(color: FlutterFlowTheme.of(context).lineColor),
                      ...
                      children: [
                                              ...
                                              Stack(
                                                children: [
                                                  Column(
                                                    ...
                                                    children: [
                                                      Image.network(
                                                        'https://www.recetasnestle.com.mx/sites/default/files/styles/recipe_detail_desktop/public/srh_recipes/427eb6d1fb8e1903124a51380128ac36.webp?itok=JQCNuFyL',
                                                        width: MediaQuery.of(
                                                                    context)
                                                                .size
                                                                .width *
                                              ...
                                              Stack(
                                                children: [
                                                  Column(
                                                    ...
                                                    children: [
                                                      Image.network(
                                                        'https://www.elsoldeparral.com.mx/incoming/hbn15j-gorditas-gorki-1.jpg/ALTERNATES/LANDSCAPE_768/GORDITAS%20GORKI%201.jpg',
                                                        width: MediaQuery.of(
                                                                    context)
                                                                .size
                                                                .width *
                        ...
                        StreamBuilder<List<RecetasRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<RecetasRecord> wrapRecetasRecordList =
                                snapshot.data!;
                            return Wrap(
                              spacing: 0.0,
                              runSpacing: 0.0,
                              ...
                              children: List.generate(
                                  wrapRecetasRecordList.length, (wrapIndex) {
